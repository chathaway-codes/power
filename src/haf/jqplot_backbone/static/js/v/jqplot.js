...
//    ], function($, Backbone, _) {
    ...
    var jqplotBaseView = Backbone.View.extend({
        jqplotOptions: {
        ...
        initialize: function() {
            ...
            if(this.options.process_data != null) {
                this.process_data = this.options.process_data;
            }
        ...
        render: function() {
            ...
            // If there is a process_data function... do it
            if(this.process_data != null) {
                elements = this.process_data(this.collection);
            } else if(this.variableType == "groups") {
