...
print PROJECT_ROOT
print os.path.realpath(__file__).split(os.sep)[:-2]
print os.path.splitdrive(PROJECT_ROOT)[0]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'power',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '1p%ek^!br#xqjsgi+tb(_f60_^@z^$w3#p)xhjvcx=69u#piob'
