...
The \ac{POW-R} project is comprised of two main hardware components, the Server and the Satellites. 
...
That one Zigbee module can talk to the Server over \ac{USB}.
...
The end product shall have a hard casing around it, \ac{NEMA} 5-15 sockets on one side, and prongs for a \ac{NEMA} 5-15 male end on the other. 
...
\input{Hardware/Satellite-Prototyping}