...
\PY{n}{urlpatterns} \PY{o}{=} \PY{n}{patterns}\PY{p}{(}\PY{l+s}{'}\PY{l+s}{'}\PY{p}{,}
    \PY{c}{\PYZsh{} Examples:}
    \PY{c}{\PYZsh{} url(r'\PYZca{}\PYZdl{}', 'power.views.home', name='home'),}
    \PY{c}{\PYZsh{} url(r'\PYZca{}power/', include('power.foo.urls')),}
    ...
    \PY{n}{url}\PY{p}{(}\PY{l+s}{r'}\PY{l+s}{\PYZca{}api/}\PY{l+s}{'}\PY{p}{,} \PY{n}{include}\PY{p}{(}\PY{n}{raw}\PY{o}{.}\PY{n}{api}\PY{o}{.}\PY{n}{urls}\PY{p}{)}\PY{p}{)}\PY{p}{,}
\PY{p}{)}
\end{Verbatim}
