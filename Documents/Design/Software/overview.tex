...
Each of these contains a \filename{models.py} file, which specifies what the database for that module should look like, an \filename{\_\_init\_\_.py} file which will register the module with the REST API, and whatever other files that module needs.
