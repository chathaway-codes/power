...
These pages either post directly to the server using standard form-submission methods (ie, not Ajax) or by using AJAX (if we have time to recreate the entire management system).
...
Time permitting, this may be recreated to be a AJAX type interface.

\subsubsection{Data Flow}

All data will be sent to the server through POST requests, not through the REST API.
