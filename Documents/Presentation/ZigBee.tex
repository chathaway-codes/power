...
\frame{\frametitle{ZigBee Overview}
	\begin{itemize}
		\item Different than XBee:
			...
			\end{itemize}
		\item All inter-Satellite ("Mesh") communication		 \cite{Book:ZigBee}
	\end{itemize}
}
...
\frame{\frametitle{How ZigBee Works}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item End-devices
		\end{itemize}
		\item Addressing scheme supports MANY radios
...
\begin{figure}
\centering
\includegraphics[scale=.35]{Diagrams/ZigBeeNetworkTypes.png}
\end{figure}
}